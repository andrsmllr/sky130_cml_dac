...
C {devices/ipin.sym} 120 -460 0 0 {name=p1 lab=ain_p}
C {devices/ipin.sym} 600 -460 2 0 {name=p2 lab=ain_n
}
...
device=resistor
m=1}
C {devices/ipin.sym} 600 -320 2 0 {name=p3 lab=bin_n}
C {devices/ipin.sym} 120 -320 0 0 {name=p4 lab=bin_p}
C {devices/opin.sym} 600 -540 0 0 {name=p5 lab=vout_p}
C {devices/opin.sym} 120 -540 2 0 {name=p6 lab=vout_n}
