...
C {devices/code_shown.sym} 1090 -1580 0 0 {name=s1 only_toplevel=false value=".lib /opt/pdks/sky130A/libs.tech/ngspice/sky130.lib.spice tt"}
C {devices/code_shown.sym} 1090 -1520 0 0 {name=s2 only_toplevel=false value=".control
dc V_DS 0 1.8 0.1 V_GS 0 1.8 0.2
plot -i(V_DS)
.endc"
